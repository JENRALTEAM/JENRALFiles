...
if Manager(msg) then
if DevAbs:get(JENRAL.."Abs:Lock:ProNames"..msg.chat_id_) then
local Txt = text:match("^وضع توحيد (.*)$") or text:match("^ضع توحيد (.*)$")
send(msg.chat_id_, msg.id_,'⌁︙تم تعيين ↫ '..Txt..' كتوحيد للمجموعه')
DevAbs:set(JENRAL.."Abs:ProNames:Txt"..msg.chat_id_,Txt)
else
...
DevAbs:set(JENRAL.."Abs:ProNames:Num"..msg.chat_id_,Num)
else
send(msg.chat_id_, msg.id_,'⌁︙ميزة التوحيد معطله يرجى تفعيلها')
end
end
...
if DevAbs:get(JENRAL.."Abs:ProNames:Txt"..msg.chat_id_) then
local ProNamesTxt = DevAbs:get(JENRAL.."Abs:ProNames:Txt"..msg.chat_id_)
local ProNamesNum = DevAbs:get(JENRAL.."Abs:ProNames:Num"..msg.chat_id_) or 5
...
if DevAbs:get(JENRAL.."Abs:Lock:ProNames"..msg.chat_id_) and DevAbs:get(JENRAL.."Abs:ProNames:Txt"..msg.chat_id_) then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(extra,result,success)
if result and result.first_name_ then 
if result.first_name_:match("(.*)"..DevAbs:get(JENRAL.."Abs:ProNames:Txt"..msg.chat_id_).."(.*)") then 
DevAbs:srem(JENRAL..'Abs:Muted:'..msg.chat_id_, msg.sender_user_id_)
else
local ProNamesTxt = DevAbs:get(JENRAL.."Abs:ProNames:Num"..msg.chat_id_) or 5
local UserNum = DevAbs:get(JENRAL.."Abs:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_) or 0
...
DevAbs:del(JENRAL.."Abs:ProNames:UserNum"..msg.chat_id_..msg.sender_user_id_)
...
DevAbs:set(JENRAL.."Abs:Lock:ProNames"..msg.chat_id_,true)
end
if text == "تعطيل التوحيد" and Constructor(msg) then
send(msg.chat_id_, msg.id_, '⌁︙تم تعطيل توحيد المجموعه')
DevAbs:del(JENRAL.."Abs:Lock:ProNames"..msg.chat_id_)
end
end
